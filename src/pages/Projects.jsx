...
import power from "../components/projects/powersydney.jpg";
import ausgrid from "../components/projects/3X3bc01117c.jpg";
    ...
    const AusProjects = () => (
      <ProjectList>
        <Project
          ...
          selectedSrc={power}
          direction="right"
          title={<span>Powering Sydney's Future (2020)</span>}
          description={
            <p>
              Early works are now underway on TransGrid's Powering Sydney's
              Future Project. These investigation works are required to verify
              the route alignment and joint bay locations so the cable
              manufacturing can commence and the design can be finalized.
              <iframe
                width="100%"
                height="315"
                src="https://www.youtube.com/embed/bve6UUoJq5o"
                frameborder="0"
        ...
        <Project
          ...
          selectedSrc={ausgrid}
          direction="right"
          title={<span>Ausgrid 3 Pack 132kV D&C Project</span>}
          description={
            <span>
              This project is consists of three separate project, Willoughby to
              Mosman (7.1km), Kingsford to Clovelly (4km) and Sydney South to
              Revesby (3.3km). Taihan has provided overall design, manufacturing
              materials, installation and commissioning test for 132kV cable
              system over 14km route length. Some of them has dual circuits and
              some other portion has dual circuit civil with single circuit
              cable installation. The most challenge on this project is
              conducting all three projects at the same time within one year
